...
u32 D_8032C6F0[] = {
    0x14000001, 0x14010001, 0x14020001, 0x14030001, 0x14040001, 0x14050001,
    0x14060001, 0x14100001, 0x14128001, 0x14110001, 0x14140001, 0x14200001,
    0x00000000, 0x400B0001, 0x400C0001, 0x400A0001, 0x40000001, 0x40010001,
    0x40020001, 0x41030001, 0x40040001, 0x40080001, 0x40050001, 0x40090001,
    0x60000001, 0x1D192001, 0x60028001, 0x60034001, 0x60104001, 0x90524001,
    0x80504001, 0x50514001, 0x40080001, 0x60044001, 0x60048001, 0x400D0001
};
s8 D_8032C780 = 0;
...
void func_80248FBC(void)
{
    ...
    {
        if (D_8032C780 == 0)
            SetSound(0x38280081, &gMarioStates[0].marioObj->gfx.unk54);
        D_8032C780 = 1;
    }
    else
    {
