...
static s32 act_breaststroke(struct MarioState *m)
{
    ...
    if (m->actionTimer == 1)
    {
        play_sound(D_8032CDD4 == 160 ? SOUND_ACTION_UNKNOWN433 : SOUND_ACTION_UNKNOWN447, m->marioObj->header.gfx.cameraToObject);
        func_8027107C(m);
    }
...
static void func_80272FA8(struct MarioState *m, u32 arg)
{
    ...
    play_sound_if_no_flag(m, arg ? SOUND_ACTION_UNKNOWN451 : SOUND_ACTION_UNKNOWN450, MARIO_ENVIRONMENT_NOISE_PLAYED);
}
