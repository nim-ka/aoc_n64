...
s32 should_start_dialog_check(f32,f32,s32);
extern s32 should_start_dialog_check_copy(f32 sp18, f32 sp1C);
...
void set_obj_anim_and_frame(s32,s32);
s32 set_obj_anim_and_check_if_near_end(s32);
void set_obj_anim_and_extend(s32);
