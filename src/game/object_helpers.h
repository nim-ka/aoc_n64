...
#endif
extern void update_pos_from_parent_transformation(Mat4, struct Object *);
...
extern void obj_init_anim_accel_and_sound(u32, f32);
extern void set_object_animation(s32 arg0);
...
void set_obj_vel_from_mario_vel(f32,f32);
BAD_RETURN(s16) obj_reverse_anim(void);
extern BAD_RETURN(s32) obj_extend_anim_if_at_end(void);
extern s32 obj_check_if_near_anim_end(void);
extern s32 obj_check_if_at_anim_end(void);
extern s32 obj_check_anim_frame(s32);
extern s32 obj_check_anim_frame_in_range(s32, s32);
// extern ? obj_check_frame_prior_current_frame(?);
s32 mario_is_in_air_action(void);
s32 mario_is_dive_sliding(void);
void set_obj_vel_y_and_anim(f32,s32);
void unrender_and_reset_obj_state(s32,s32);
...
// extern ? obj_advance_looping_anim(?);
...
extern void set_throw_matrix_from_transform(struct Object *);
extern void build_object_transform_relative_to_parent(struct Object *);
// extern ? create_transform_from_self(?);
...
// extern ? build_vel_from_transform(?);
