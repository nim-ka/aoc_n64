...
// extern ? BehTHIHugeIslandTopLoop(?);
// extern ? BehTHITinyIslandTopLoop(?);
...
// extern ? BehYellowCoinInit(?);
// extern ? BehYellowCoinLoop(?);
// extern ? BehTempCoinLoop(?);
// extern ? BehCoinInit(?);
// extern ? BehCoinLoop(?);
...
// extern ? BehRRRotatingBridgePlatformLoop(?);
...
// extern ? BehWFSolidTowerPlatformLoop(?);
// extern ? BehWFElevatorTowerPlatformLoop(?);
// extern ? BehWFSlidingTowerPlatformLoop(?);
...
// extern ? BehLLLMovingOctagonalMeshPlatformLoop(?);
// extern ? BehLLLSinkingRockBlockLoop(?);
...
// extern ? BehLLLRotatingBlockFireBarsLoop(?);
// extern ? BehLllWoodPieceLoop(?);
// extern ? BehLLLFloatingWoodBridgeLoop(?);
// extern ? BehVolcanoFlamesLoop(?);
// extern ? func_802BBFDC(?);
// extern ? BehLLLRotatingHexagonalRingLoop(?);
// extern ? func_802BC390(?);
// extern ? BehLLLSinkingRectangularPlatformLoop(?);
// extern ? BehLLLSinkingSquarePlatformsLoop(?);
...
// extern ? BehLLLBowserPuzzlePieceLoop(?);
...
// extern ? BehInitChangingWaterLevelLoop(?);
// extern ? BehWaterLevelDiamondLoop(?);
