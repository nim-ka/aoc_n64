...
void func_802DFA24(void) {
    ...
    for (sp1C = 0; sp1C < D_803600CC; sp1C++) {
        ...
        if ((D_80360090 + sp1C)->unk00 == 0) {
            ...
            (D_80360090 + sp1C)->unk04 = D_803600B0[1] + sins((D_80360090 + sp1C)->unk10[0]) * (sp1C + D_80360090)->unk10[1];
            (D_80360090 + sp1C)->unk0C = D_803600B0[3] + coss((D_80360090 + sp1C)->unk10[0]) * (sp1C + D_80360090)->unk10[1];
