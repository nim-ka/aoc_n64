...
** outside of the files in which they were defined. The only possible reason
** I can come up with for this behavior is that goddard only declared (not prototyped)
** his functions in the headers, and either didn't include the header in the 
** function's defining file, or irix just didn't care that the declaration would
** cause inappropriate promotion of types.
**
