...
void DisplayFrameBuffer(void)
{
...

    {
        Gfx *g = D_80339CFC++;
        g->words.w0 = 0xFF10013F;
        g->words.w1 = (u32)D_80339CE0[D_8032C69C];
    }
...
void func_80247D84(void)
{
    ...
    if (D_8032C644 != 0 && D_8032C648 < 15)
    {
        ...
        sp18 = (u64 *)((u32)D_80339CE0[sp1C] | 0x80000000);
        sp18 += D_8032C648++ * 80;
...
void func_80247ED8(void)
{
    ...
    D_80339CFC = D_80339D04;
    D_80339D00 = (u8 *)D_80339D04 + 51200;
    func_80247C9C();
    ClearFrameBuffer(0);
    CleanupDisplayList();
...
void func_80248060(void)
{
    ...
    func_8027DE30(3);
    osRecvMesg(&D_80339CA0, &D_80339BEC, 1);
    osViSwapBuffer((void *)((u32)D_80339CE0[D_8032C698] | 0x80000000));
    func_8027DE30(4);
    osRecvMesg(&D_80339CA0, &D_80339BEC, 1);
    if (++D_8032C698 == 3)
        D_8032C698 = 0;
