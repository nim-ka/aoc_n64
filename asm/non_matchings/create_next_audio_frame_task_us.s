...
/* 0D97B8 8031E7B8 3C048022 */  lui   $a0, %hi(gActiveAudioFrames) # $a0, 0x8022
/* 0D97BC 8031E7BC 24846B80 */  addiu $a0, %lo(gActiveAudioFrames) # addiu $a0, $a0, 0x6b80
/* 0D97C0 8031E7C0 8C820000 */  lw    $v0, ($a0)
/* 0D97C4 8031E7C4 27BDFFB8 */  addiu $sp, $sp, -0x48
/* 0D97C8 8031E7C8 3C0F8033 */  lui   $t7, %hi(gAudioLoadLock) # $t7, 0x8033
/* 0D97CC 8031E7CC 244E0001 */  addiu $t6, $v0, 1
/* 0D97D0 8031E7D0 AFBF0014 */  sw    $ra, 0x14($sp)
/* 0D97D4 8031E7D4 AC8E0000 */  sw    $t6, ($a0)
/* 0D97D8 8031E7D8 25EF5004 */  addiu $t7, %lo(gAudioLoadLock) # addiu $t7, $t7, 0x5004
...
.L_U_8031E7F8:
/* 0D97F8 8031E7F8 3C078022 */  lui   $a3, %hi(gCurrAiBufferIndex) # $a3, 0x8022
/* 0D97FC 8031E7FC 24E76B8C */  addiu $a3, %lo(gCurrAiBufferIndex) # addiu $a3, $a3, 0x6b8c
/* 0D9800 8031E800 8CED0000 */  lw    $t5, ($a3)
/* 0D9804 8031E804 3C038022 */  lui   $v1, %hi(gAudioTaskIndex) # $v1, 0x8022
/* 0D9808 8031E808 24636B88 */  addiu $v1, %lo(gAudioTaskIndex) # addiu $v1, $v1, 0x6b88
...
/* 0D9898 8031E898 3C038022 */  lui   $v1, %hi(gAiBufferLengths)
/* 0D989C 8031E89C 3C078022 */  lui   $a3, %hi(gCurrAiBufferIndex) # $a3, 0x8022
/* 0D98A0 8031E8A0 00066840 */  sll   $t5, $a2, 1
/* 0D98A4 8031E8A4 006D1821 */  addu  $v1, $v1, $t5
/* 0D98A8 8031E8A8 84636C4C */  lh    $v1, %lo(gAiBufferLengths)($v1)
/* 0D98AC 8031E8AC 24E76B8C */  addiu $a3, %lo(gCurrAiBufferIndex) # addiu $a3, $a3, 0x6b8c
/* 0D98B0 8031E8B0 00025082 */  srl   $t2, $v0, 2
/* 0D98B4 8031E8B4 1060000A */  beqz  $v1, .L_U_8031E8E0
/* 0D98B8 8031E8B8 00067080 */   sll   $t6, $a2, 2
/* 0D98BC 8031E8BC 3C048022 */  lui   $a0, %hi(gAiBuffers)
/* 0D98C0 8031E8C0 008E2021 */  addu  $a0, $a0, $t6
/* 0D98C4 8031E8C4 8C846C40 */  lw    $a0, %lo(gAiBuffers)($a0)
/* 0D98C8 8031E8C8 00032880 */  sll   $a1, $v1, 2
/* 0D98CC 8031E8CC 0C0C976C */  jal   osAiSetNextBuffer
/* 0D98D0 8031E8D0 AFAA0044 */   sw    $t2, 0x44($sp)
/* 0D98D4 8031E8D4 3C078022 */  lui   $a3, %hi(gCurrAiBufferIndex) # $a3, 0x8022
/* 0D98D8 8031E8D8 24E76B8C */  addiu $a3, %lo(gCurrAiBufferIndex) # addiu $a3, $a3, 0x6b8c
/* 0D98DC 8031E8DC 8FAA0044 */  lw    $t2, 0x44($sp)
.L_U_8031E8E0:
/* 0D98E0 8031E8E0 3C0B8022 */  lui   $t3, %hi(gActiveAudioDmasCount) # $t3, 0x8022
/* 0D98E4 8031E8E4 256B6B84 */  addiu $t3, %lo(gActiveAudioDmasCount) # addiu $t3, $t3, 0x6b84
/* 0D98E8 8031E8E8 8D620000 */  lw    $v0, ($t3)
/* 0D98EC 8031E8EC AD600000 */  sw    $zero, ($t3)
/* 0D98F0 8031E8F0 3C028022 */  lui   $v0, %hi(gAudioTaskIndex) # $v0, 0x8022
/* 0D98F4 8031E8F4 8C426B88 */  lw    $v0, %lo(gAudioTaskIndex)($v0)
/* 0D98F8 8031E8F8 3C188022 */  lui   $t8, %hi(gAudioTasks) # $t8, 0x8022
/* 0D98FC 8031E8FC 3C098022 */  lui   $t1, %hi(gAudioTask) # $t1, 0x8022
/* 0D9900 8031E900 00027880 */  sll   $t7, $v0, 2
/* 0D9904 8031E904 01E27821 */  addu  $t7, $t7, $v0
/* 0D9908 8031E908 000F7900 */  sll   $t7, $t7, 4
/* 0D990C 8031E90C 27186BA0 */  addiu $t8, %lo(gAudioTasks) # addiu $t8, $t8, 0x6ba0
/* 0D9910 8031E910 25296B9C */  addiu $t1, %lo(gAudioTask) # addiu $t1, $t1, 0x6b9c
/* 0D9914 8031E914 01F8C821 */  addu  $t9, $t7, $t8
/* 0D9918 8031E918 3C0D8022 */  lui   $t5, %hi(gAudioCmdBuffers)
/* 0D991C 8031E91C 00026080 */  sll   $t4, $v0, 2
/* 0D9920 8031E920 AD390000 */  sw    $t9, ($t1)
/* 0D9924 8031E924 01AC6821 */  addu  $t5, $t5, $t4
/* 0D9928 8031E928 8DAD6B90 */  lw    $t5, %lo(gAudioCmdBuffers)($t5)
/* 0D992C 8031E92C 3C018022 */  lui   $at, %hi(gAudioCmd) # $at, 0x8022
/* 0D9930 8031E930 3C048022 */  lui   $a0, %hi(D_80226D74) # $a0, 0x8022
/* 0D9934 8031E934 AC2D6B98 */  sw    $t5, %lo(gAudioCmd)($at)
/* 0D9938 8031E938 8CE60000 */  lw    $a2, ($a3)
/* 0D993C 8031E93C 8C846B74 */  lw    $a0, %lo(D_80226D74)($a0)
/* 0D9940 8031E940 3C0F8022 */  lui   $t7, %hi(gAiBuffers)
/* 0D9944 8031E944 00067080 */  sll   $t6, $a2, 2
/* 0D9948 8031E948 01EE7821 */  addu  $t7, $t7, $t6
/* 0D994C 8031E94C 8DEF6C40 */  lw    $t7, %lo(gAiBuffers)($t7)
/* 0D9950 8031E950 008A6023 */  subu  $t4, $a0, $t2
/* 0D9954 8031E954 3C018036 */  lui   $at, %hi(gCurrAiBuffer) # $at, 0x8036
/* 0D9958 8031E958 258D0040 */  addiu $t5, $t4, 0x40
/* 0D995C 8031E95C 3C198022 */  lui   $t9, %hi(gAiBufferLengths) # $t9, 0x8022
/* 0D9960 8031E960 27396C4C */  addiu $t9, %lo(gAiBufferLengths) # addiu $t9, $t9, 0x6c4c
/* 0D9964 8031E964 31AEFFF0 */  andi  $t6, $t5, 0xfff0
/* 0D9968 8031E968 0006C040 */  sll   $t8, $a2, 1
/* 0D996C 8031E96C AC2F1490 */  sw    $t7, %lo(gCurrAiBuffer)($at)
/* 0D9970 8031E970 25CF0010 */  addiu $t7, $t6, 0x10
/* 0D9974 8031E974 03194021 */  addu  $t0, $t8, $t9
/* 0D9978 8031E978 A50F0000 */  sh    $t7, ($t0)
/* 0D997C 8031E97C 3C058022 */  lui   $a1, %hi(gMinAiBufferLength) # $a1, 0x8022
/* 0D9980 8031E980 8CA56B78 */  lw    $a1, %lo(gMinAiBufferLength)($a1)
/* 0D9984 8031E984 85030000 */  lh    $v1, ($t0)
/* 0D9988 8031E988 3C188033 */  lui   $t8, %hi(sGameLoopTicked) # $t8, 0x8033
...
.L_U_8031E9B4:
/* 0D99B4 8031E9B4 8F182E54 */  lw    $t8, %lo(sGameLoopTicked)($t8)
/* 0D99B8 8031E9B8 13000006 */  beqz  $t8, .L_U_8031E9D4
/* 0D99BC 8031E9BC 00000000 */   nop   
/* 0D99C0 8031E9C0 0C0C7F6B */  jal   update_game_sound
/* 0D99C4 8031E9C4 AFA80028 */   sw    $t0, 0x28($sp)
/* 0D99C8 8031E9C8 3C018033 */  lui   $at, %hi(sGameLoopTicked) # $at, 0x8033
/* 0D99CC 8031E9CC 8FA80028 */  lw    $t0, 0x28($sp)
/* 0D99D0 8031E9D0 AC202E54 */  sw    $zero, %lo(sGameLoopTicked)($at)
.L_U_8031E9D4:
/* 0D99D4 8031E9D4 3C048022 */  lui   $a0, %hi(gAudioCmd) # $a0, 0x8022
/* 0D99D8 8031E9D8 3C068036 */  lui   $a2, %hi(gCurrAiBuffer) # $a2, 0x8036
/* 0D99DC 8031E9DC 8CC61490 */  lw    $a2, %lo(gCurrAiBuffer)($a2)
/* 0D99E0 8031E9E0 8C846B98 */  lw    $a0, %lo(gAudioCmd)($a0)
/* 0D99E4 8031E9E4 27A50040 */  addiu $a1, $sp, 0x40
/* 0D99E8 8031E9E8 0C0C5379 */  jal   func_80313CD4
/* 0D99EC 8031E9EC 85070000 */   lh    $a3, ($t0)
/* 0D99F0 8031E9F0 3C088022 */  lui   $t0, %hi(gActiveAudioFrames) # $t0, 0x8022
/* 0D99F4 8031E9F4 3C018022 */  lui   $at, %hi(gAudioCmd) # $at, 0x8022
/* 0D99F8 8031E9F8 AC226B98 */  sw    $v0, %lo(gAudioCmd)($at)
/* 0D99FC 8031E9FC 25086B80 */  addiu $t0, %lo(gActiveAudioFrames) # addiu $t0, $t0, 0x6b80
...
/* 0D9A14 8031EA14 3C098022 */  lui   $t1, %hi(gAudioTask) # $t1, 0x8022
/* 0D9A18 8031EA18 032C6821 */  addu  $t5, $t9, $t4
/* 0D9A1C 8031EA1C 01AE0019 */  multu $t5, $t6
/* 0D9A20 8031EA20 25296B9C */  addiu $t1, %lo(gAudioTask) # addiu $t1, $t1, 0x6b9c
/* 0D9A24 8031EA24 8D380000 */  lw    $t8, ($t1)
/* 0D9A28 8031EA28 3C068022 */  lui   $a2, %hi(gAudioTaskIndex) # $a2, 0x8022
...
/* 0D9A4C 8031EA4C 8CC66B88 */  lw    $a2, %lo(gAudioTaskIndex)($a2)
...
/* 0D9A98 8031EA98 3C188022 */  lui   $t8, %hi(gAudioCmdBuffers)
...
/* 0D9AC4 8031EAC4 8F186B90 */  lw    $t8, %lo(gAudioCmdBuffers)($t8)
...
/* 0D9AE4 8031EAE4 3C098022 */  lui   $t1, %hi(gAudioTask) # $t1, 0x8022
/* 0D9AE8 8031EAE8 25296B9C */  addiu $t1, %lo(gAudioTask) # addiu $t1, $t1, 0x6b9c
