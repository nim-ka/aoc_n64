...
/* 0D8924 8031D924 3C048022 */  lui   $a0, %hi(gActiveAudioFrames) # $a0, 0x8022
/* 0D8928 8031D928 24846D80 */  addiu $a0, %lo(gActiveAudioFrames) # addiu $a0, $a0, 0x6d80
/* 0D892C 8031D92C 8C820000 */  lw    $v0, ($a0)
/* 0D8930 8031D930 27BDFFB8 */  addiu $sp, $sp, -0x48
/* 0D8934 8031D934 3C0F8033 */  lui   $t7, %hi(gAudioLoadLock) # $t7, 0x8033
/* 0D8938 8031D938 244E0001 */  addiu $t6, $v0, 1
/* 0D893C 8031D93C AFBF0014 */  sw    $ra, 0x14($sp)
/* 0D8940 8031D940 AC8E0000 */  sw    $t6, ($a0)
/* 0D8944 8031D944 25EF3EF4 */  addiu $t7, %lo(gAudioLoadLock) # addiu $t7, $t7, 0x3ef4
...
.L8031D964:
/* 0D8964 8031D964 3C078022 */  lui   $a3, %hi(gCurrAiBufferIndex) # $a3, 0x8022
/* 0D8968 8031D968 24E76D8C */  addiu $a3, %lo(gCurrAiBufferIndex) # addiu $a3, $a3, 0x6d8c
/* 0D896C 8031D96C 8CED0000 */  lw    $t5, ($a3)
/* 0D8970 8031D970 3C038022 */  lui   $v1, %hi(gAudioTaskIndex) # $v1, 0x8022
/* 0D8974 8031D974 24636D88 */  addiu $v1, %lo(gAudioTaskIndex) # addiu $v1, $v1, 0x6d88
...
/* 0D8A04 8031DA04 3C038022 */  lui   $v1, %hi(gAiBufferLengths)
/* 0D8A08 8031DA08 3C078022 */  lui   $a3, %hi(gCurrAiBufferIndex) # $a3, 0x8022
/* 0D8A0C 8031DA0C 00066840 */  sll   $t5, $a2, 1
/* 0D8A10 8031DA10 006D1821 */  addu  $v1, $v1, $t5
/* 0D8A14 8031DA14 84636E4C */  lh    $v1, %lo(gAiBufferLengths)($v1)
/* 0D8A18 8031DA18 24E76D8C */  addiu $a3, %lo(gCurrAiBufferIndex) # addiu $a3, $a3, 0x6d8c
/* 0D8A1C 8031DA1C 00025082 */  srl   $t2, $v0, 2
/* 0D8A20 8031DA20 1060000A */  beqz  $v1, .L8031DA4C
/* 0D8A24 8031DA24 00067080 */   sll   $t6, $a2, 2
/* 0D8A28 8031DA28 3C048022 */  lui   $a0, %hi(gAiBuffers)
/* 0D8A2C 8031DA2C 008E2021 */  addu  $a0, $a0, $t6
/* 0D8A30 8031DA30 8C846E40 */  lw    $a0, %lo(gAiBuffers)($a0)
/* 0D8A34 8031DA34 00032880 */  sll   $a1, $v1, 2
/* 0D8A38 8031DA38 0C0C93A0 */  jal   osAiSetNextBuffer
/* 0D8A3C 8031DA3C AFAA0044 */   sw    $t2, 0x44($sp)
/* 0D8A40 8031DA40 3C078022 */  lui   $a3, %hi(gCurrAiBufferIndex) # $a3, 0x8022
/* 0D8A44 8031DA44 24E76D8C */  addiu $a3, %lo(gCurrAiBufferIndex) # addiu $a3, $a3, 0x6d8c
/* 0D8A48 8031DA48 8FAA0044 */  lw    $t2, 0x44($sp)
.L8031DA4C:
/* 0D8A4C 8031DA4C 3C0B8022 */  lui   $t3, %hi(gActiveAudioDmasCount) # $t3, 0x8022
/* 0D8A50 8031DA50 256B6D84 */  addiu $t3, %lo(gActiveAudioDmasCount) # addiu $t3, $t3, 0x6d84
/* 0D8A54 8031DA54 8D620000 */  lw    $v0, ($t3)
/* 0D8A58 8031DA58 AD600000 */  sw    $zero, ($t3)
/* 0D8A5C 8031DA5C 3C028022 */  lui   $v0, %hi(gAudioTaskIndex) # $v0, 0x8022
/* 0D8A60 8031DA60 8C426D88 */  lw    $v0, %lo(gAudioTaskIndex)($v0)
/* 0D8A64 8031DA64 3C188022 */  lui   $t8, %hi(gAudioTasks) # $t8, 0x8022
/* 0D8A68 8031DA68 3C098022 */  lui   $t1, %hi(gAudioTask) # $t1, 0x8022
/* 0D8A6C 8031DA6C 00027880 */  sll   $t7, $v0, 2
/* 0D8A70 8031DA70 01E27821 */  addu  $t7, $t7, $v0
/* 0D8A74 8031DA74 000F7900 */  sll   $t7, $t7, 4
/* 0D8A78 8031DA78 27186DA0 */  addiu $t8, %lo(gAudioTasks) # addiu $t8, $t8, 0x6da0
/* 0D8A7C 8031DA7C 25296D9C */  addiu $t1, %lo(gAudioTask) # addiu $t1, $t1, 0x6d9c
/* 0D8A80 8031DA80 01F8C821 */  addu  $t9, $t7, $t8
/* 0D8A84 8031DA84 3C0D8022 */  lui   $t5, %hi(gAudioCmdBuffers)
/* 0D8A88 8031DA88 00026080 */  sll   $t4, $v0, 2
/* 0D8A8C 8031DA8C AD390000 */  sw    $t9, ($t1)
/* 0D8A90 8031DA90 01AC6821 */  addu  $t5, $t5, $t4
/* 0D8A94 8031DA94 8DAD6D90 */  lw    $t5, %lo(gAudioCmdBuffers)($t5)
/* 0D8A98 8031DA98 3C018022 */  lui   $at, %hi(gAudioCmd) # $at, 0x8022
/* 0D8A9C 8031DA9C 3C048022 */  lui   $a0, %hi(D_80226D74) # $a0, 0x8022
/* 0D8AA0 8031DAA0 AC2D6D98 */  sw    $t5, %lo(gAudioCmd)($at)
/* 0D8AA4 8031DAA4 8CE60000 */  lw    $a2, ($a3)
/* 0D8AA8 8031DAA8 8C846D74 */  lw    $a0, %lo(D_80226D74)($a0)
/* 0D8AAC 8031DAAC 3C0F8022 */  lui   $t7, %hi(gAiBuffers)
/* 0D8AB0 8031DAB0 00067080 */  sll   $t6, $a2, 2
/* 0D8AB4 8031DAB4 01EE7821 */  addu  $t7, $t7, $t6
/* 0D8AB8 8031DAB8 8DEF6E40 */  lw    $t7, %lo(gAiBuffers)($t7)
/* 0D8ABC 8031DABC 008A6023 */  subu  $t4, $a0, $t2
/* 0D8AC0 8031DAC0 3C018036 */  lui   $at, %hi(gCurrAiBuffer) # $at, 0x8036
/* 0D8AC4 8031DAC4 258D0040 */  addiu $t5, $t4, 0x40
/* 0D8AC8 8031DAC8 3C198022 */  lui   $t9, %hi(gAiBufferLengths) # $t9, 0x8022
/* 0D8ACC 8031DACC 27396E4C */  addiu $t9, %lo(gAiBufferLengths) # addiu $t9, $t9, 0x6e4c
/* 0D8AD0 8031DAD0 31AEFFF0 */  andi  $t6, $t5, 0xfff0
/* 0D8AD4 8031DAD4 0006C040 */  sll   $t8, $a2, 1
/* 0D8AD8 8031DAD8 AC2F0120 */  sw    $t7, %lo(gCurrAiBuffer)($at)
/* 0D8ADC 8031DADC 25CF0010 */  addiu $t7, $t6, 0x10
/* 0D8AE0 8031DAE0 03194021 */  addu  $t0, $t8, $t9
/* 0D8AE4 8031DAE4 A50F0000 */  sh    $t7, ($t0)
/* 0D8AE8 8031DAE8 3C058022 */  lui   $a1, %hi(gMinAiBufferLength) # $a1, 0x8022
/* 0D8AEC 8031DAEC 8CA56D78 */  lw    $a1, %lo(gMinAiBufferLength)($a1)
/* 0D8AF0 8031DAF0 85030000 */  lh    $v1, ($t0)
/* 0D8AF4 8031DAF4 3C188033 */  lui   $t8, %hi(sGameLoopTicked) # $t8, 0x8033
...
.L8031DB20:
/* 0D8B20 8031DB20 8F181D44 */  lw    $t8, %lo(sGameLoopTicked)($t8)
/* 0D8B24 8031DB24 13000006 */  beqz  $t8, .L8031DB40
/* 0D8B28 8031DB28 00000000 */   nop   
/* 0D8B2C 8031DB2C 0C0C7BBE */  jal   update_game_sound
/* 0D8B30 8031DB30 AFA80028 */   sw    $t0, 0x28($sp)
/* 0D8B34 8031DB34 3C018033 */  lui   $at, %hi(sGameLoopTicked) # $at, 0x8033
/* 0D8B38 8031DB38 8FA80028 */  lw    $t0, 0x28($sp)
/* 0D8B3C 8031DB3C AC201D44 */  sw    $zero, %lo(sGameLoopTicked)($at)
.L8031DB40:
/* 0D8B40 8031DB40 3C048022 */  lui   $a0, %hi(gAudioCmd) # $a0, 0x8022
/* 0D8B44 8031DB44 3C068036 */  lui   $a2, %hi(gCurrAiBuffer) # $a2, 0x8036
/* 0D8B48 8031DB48 8CC60120 */  lw    $a2, %lo(gCurrAiBuffer)($a2)
/* 0D8B4C 8031DB4C 8C846D98 */  lw    $a0, %lo(gAudioCmd)($a0)
/* 0D8B50 8031DB50 27A50040 */  addiu $a1, $sp, 0x40
/* 0D8B54 8031DB54 0C0C4F35 */  jal   func_80313CD4
/* 0D8B58 8031DB58 85070000 */   lh    $a3, ($t0)
/* 0D8B5C 8031DB5C 3C088022 */  lui   $t0, %hi(gActiveAudioFrames) # $t0, 0x8022
/* 0D8B60 8031DB60 3C018022 */  lui   $at, %hi(gAudioCmd) # $at, 0x8022
/* 0D8B64 8031DB64 AC226D98 */  sw    $v0, %lo(gAudioCmd)($at)
/* 0D8B68 8031DB68 25086D80 */  addiu $t0, %lo(gActiveAudioFrames) # addiu $t0, $t0, 0x6d80
...
/* 0D8B80 8031DB80 3C098022 */  lui   $t1, %hi(gAudioTask) # $t1, 0x8022
/* 0D8B84 8031DB84 032C6821 */  addu  $t5, $t9, $t4
/* 0D8B88 8031DB88 01AE0019 */  multu $t5, $t6
/* 0D8B8C 8031DB8C 25296D9C */  addiu $t1, %lo(gAudioTask) # addiu $t1, $t1, 0x6d9c
/* 0D8B90 8031DB90 8D380000 */  lw    $t8, ($t1)
/* 0D8B94 8031DB94 3C068022 */  lui   $a2, %hi(gAudioTaskIndex) # $a2, 0x8022
...
/* 0D8BB8 8031DBB8 8CC66D88 */  lw    $a2, %lo(gAudioTaskIndex)($a2)
...
/* 0D8C04 8031DC04 3C188022 */  lui   $t8, %hi(gAudioCmdBuffers)
...
/* 0D8C30 8031DC30 8F186D90 */  lw    $t8, %lo(gAudioCmdBuffers)($t8)
...
/* 0D8C5C 8031DC5C 3C098022 */  lui   $t1, %hi(gAudioTask) # $t1, 0x8022
/* 0D8C60 8031DC60 25296D9C */  addiu $t1, %lo(gAudioTask) # addiu $t1, $t1, 0x6d9c
