...
/* 0D5940 8031A940 3C048022 */  lui   $a0, %hi(D_80225E98) 
...
.else
/* 0D5FC8 8031AFC8 24150030 */  li    $s5, 52
.endif
.L8031AFCC:
...
.L8031C0E8:
/* 0D70E8 8031C0E8 3C018033 */  lui   $at,  %hi(D_80337D00)
/* 0D70EC 8031C0EC D4307D00 */  ldc1  $f16, %lo(D_80337D00)($at)
...
.else
/* 0D8068 8031D068 30AE00FF */  andi  $t6, $a1, 0xff
/* 0D806C 8031D06C 448E2000 */  mtc1  $t6, $f4
/* 0D8070 8031D070 3C0142FE */  li    $at, 0x42FE0000 # 127.000000
/* 0D8074 8031D074 44814000 */  mtc1  $at, $f8
/* 0D8078 8031D078 468021A0 */  cvt.s.w $f6, $f4
/* 0D807C 8031D07C AFA50004 */  sw    $a1, 4($sp)
/* 0D8080 8031D080 46083283 */  div.s $f10, $f6, $f8
/* 0D8084 8031D084 03E00008 */  jr    $ra
/* 0D8088 8031D088 E48A0020 */   swc1  $f10, 0x20($a0)
.endif
...
/* 0D8434 8031D434 3C0F8022 */  lui   $t7, %hi(D_80222A18) 
...
.else
/* 0D9320 8031E320 24081680 */  li    $t0, 5760
.endif
...
.else
/* 0D93D8 8031E3D8 24040034 */  li    $a0, 52
.endif
...
/* 0D857C 8031D57C 3C088022 */  lui   $t0, %hi(D_80222A18)
/* 0D8580 8031D580 25122A18 */  addiu $s2, $t0, %lo(D_80222A18)
/* 0D8584 8031D584 3C158022 */  lui   $s5, %hi(D_80222A18 + 0x90) # $s5, 0x8022
...
/* 0D8590 8031D590 26B52AA8 */  addiu $s5, %lo(D_80222A18 + 0x90) # addiu $s5, $s5, 0x2aa8
