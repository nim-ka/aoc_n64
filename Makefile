...
ASM_DIRS := asm data geo levels sound demos
BIN_DIRS := bin
...
CC_CHECK := gcc -fsyntax-only -fsigned-char -I include -std=c99 -Wall -Wextra -pedantic -Wno-format-security $(VERSION_CFLAGS)
