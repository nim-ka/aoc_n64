...
CC_CHECK := gcc -fsyntax-only -fsigned-char -I include -std=c99 -Wall -Wextra -pedantic -Wno-cast-function-type -Wno-format-security -Wno-empty-body -Werror $(VERSION_CFLAGS)
