...
glabel eyerock_geo_0002AC # 0x0C0002AC
   geo_dl_translated 0x01, 0, 0, 0
   geo_open_node
      geo_dl_translated 0x01, 0, 0, 0
      geo_open_node
         ...
         geo_open_node
            geo_dl_translated 0x01, 0, 0, 0, eyerock_seg5_dl_0500C640
            ...
            geo_open_node
               ...
               geo_open_node
                  ...
                  geo_open_node
                     ...
                     geo_open_node
                        geo_dl_translated 0x01, 0, 0, 0, eyerock_seg5_dl_0500BF00
                     geo_close_node
                     geo_dl_translated 0x01, 0, 0, 0, eyerock_seg5_dl_0500C100
                  geo_close_node
                  geo_dl_translated 0x01, 0, 0, 0, eyerock_seg5_dl_0500C378
               geo_close_node
            geo_close_node
            ...
            geo_close_node
         geo_close_node
         geo_dl_translated 0x01, 0, 0, 0, eyerock_seg5_dl_0500C908
         geo_open_node
            geo_switch_case 4, GeoSwitchCase8029DB48
            geo_open_node
               geo_display_list 0x04, eyerock_seg5_dl_0500C9B8
               geo_display_list 0x04, eyerock_seg5_dl_0500CA50
               geo_display_list 0x04, eyerock_seg5_dl_0500CAE8
               geo_display_list 0x04, eyerock_seg5_dl_0500CB80
            geo_close_node
         geo_close_node
         ...
         geo_open_node
            ...
            geo_open_node
               ...
               geo_open_node
                  geo_dl_translated 0x01, 0, 0, 0, eyerock_seg5_dl_0500BC88
                  ...
                  geo_open_node
                     ...
                     geo_open_node
                        ...
                        geo_open_node
                           geo_dl_translated 0x01, 0, 0, 0, eyerock_seg5_dl_0500B748
                        geo_close_node
                        geo_dl_translated 0x01, 0, 0, 0, eyerock_seg5_dl_0500B9C0
                     geo_close_node
                  geo_close_node
               geo_close_node
            geo_close_node
...
glabel eyerock_geo # 0x0C0005A8
   geo_shadow SHADOW_SQUARE_SCALABLE, 0xB4, 300
   geo_open_node
      geo_scale 0x00, 16384
      geo_open_node
         geo_display_list 0x01, eyerock_seg5_dl_0500CC18
         geo_branch 1, eyerock_geo_0002AC
         geo_display_list 0x01, eyerock_seg5_dl_0500CC30
      geo_close_node
   geo_close_node
   geo_end

glabel eyerock2_geo # 0x0C0005E4
   geo_shadow SHADOW_SQUARE_SCALABLE, 0xB4, 300
   geo_open_node
      geo_scale 0x00, 16384
      geo_open_node
...
glabel pokey_head_geo # 0x0C000610
   ...
   geo_open_node
      ...
      geo_open_node
         geo_display_list 0x04, pokey_head_seg5_dl_050127D8
         geo_display_list 0x04, pokey_head_seg5_dl_05012808
      geo_close_node
   geo_close_node
   geo_end
...
glabel pokey_body_part_geo # 0x0C000644
   geo_shadow SHADOW_CIRCLE_UNK1, 0x96, 50
   geo_open_node
      geo_display_list 0x04, pokey_body_part_seg5_dl_050130B0
   geo_close_node
   geo_end
