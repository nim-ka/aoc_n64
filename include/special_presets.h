...
static struct SpecialPreset SpecialObjectPresets[] = 
{
    ...
    {0x21, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_BOWSER, beh_bowser},
    ...
    {0x27, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_WF_TUMBLING_BRIDGE, beh_wf_tumbling_bridge},
    ...
    {0x89, SPTYPE_YROT_NO_PARAMS    , 0x00, MODEL_CASTLE_CASTLE_DOOR2, beh_door},
    {0x7E, SPTYPE_YROT_NO_PARAMS    , 0x00, MODEL_CASTLE_WOODEN_DOOR2, beh_door},
    ...
    {0x88, SPTYPE_PARAMS_AND_YROT   , 0x00, MODEL_CASTLE_CASTLE_DOOR, beh_door_warp},
    {0x83, SPTYPE_PARAMS_AND_YROT   , 0x00, MODEL_CASTLE_WOODEN_DOOR, beh_door_warp},
