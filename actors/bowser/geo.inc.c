// 0x0D0000D8
const uintptr_t bowser_geo_0000D8[] = {
...
// 0x0D000424
const uintptr_t bowser_geo_000424[] = {
   GEO_SHADOW(SHADOW_CIRCLE_9_VERTS, 0x9B, 400),
   GEO_OPEN_NODE(),
#ifdef VERSION_JP
...
// 0x0D000770
const uintptr_t bowser_geo_000770[] = {
   GEO_NODE_START(),
   GEO_OPEN_NODE(),
#ifdef VERSION_JP
      GEO_ANIMATED_PART(LAYER_TRANSPARENT, 0, 0, 0, bowser_seg6_dl_06040210),
...
#ifndef VERSION_JP
// 0x0D000AB8
const uintptr_t bowser_shadow_geo[] = {
